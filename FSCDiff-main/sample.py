...
def get_loader(cfg):
    cod10k_test_dataset = instantiate_from_config(cfg.test_dataset.USOD10K)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint', type=str, default='/root/autodl-tmp/CamoDiffusion-main/wandb/offline-run-20250101_141733-8ngbgusu/model-best.pt')
    ...
    for dataset, dataset_name in target_dataset:
        trainer.model.eval()
        mask_path = Path(cfg.test_dataset.USOD10K.params.image_root).parent.parent
